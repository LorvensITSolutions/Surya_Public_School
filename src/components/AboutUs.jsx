...
export default function AboutUs() {
  return (
    <section
      id="about"
      className=" overflow-hidden bg-[#FFFFFF] pb-16 pt-10 font-['Montserrat',sans-serif] sm:pb-20 lg:pb-28"
    ...
    >
      <div className="mx-auto max-w-[1320px] px-4 pt-0 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl pt-3 text-center sm:pt-4">
          ...
          <h2
            id="about-heading"
            className="mt-4 text-3xl font-black leading-[1.1] tracking-tight text-[#2C4C34] sm:text-4xl lg:text-5xl"
          >
          ...
          <p className="mt-5 text-sm font-semibold italic leading-relaxed text-[#2C4C34] sm:text-base lg:text-lg">
            &quot;Inspiring ethics, igniting curiosity, shaping well-rounded
            individuals.&quot;
          </p>
        </div>
        ...
        <div className="mt-16 overflow-hidden rounded-2xl border-2 border-[#2C4C34] lg:mt-20">
          ...
          <div className="border-b-2 border-[#D6A51A] bg-[#FFFFFF] px-4 py-6 shadow-sm sm:px-6 sm:py-8 lg:py-10">
            <div className="mx-auto grid max-w-[1200px] items-center gap-8 lg:grid-cols-2 lg:gap-12">
              <figure className="overflow-hidden rounded-lg border-2 border-[#D6A51A] bg-[#2C4C34]">
                <img
                  src={campusImage}
                  alt="Surya Public School campus"
                  className="aspect-4/3 w-full object-cover object-center sm:aspect-16/10 lg:aspect-auto lg:max-h-[min(520px,55vh)] lg:min-h-[320px]"
                  loading="lazy"
                />
              </figure>
